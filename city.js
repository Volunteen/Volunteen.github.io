...
function setupMap(placeList){
	var markers = new L.MarkerClusterGroup({animateAddingMarkers: true, maxClusterRadius: 50, spiderfyOnMaxZoon: true, showCoverageOnHover:true, zoomToBoundsOnClick: true});
