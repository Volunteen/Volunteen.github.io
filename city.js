...
function setupMap(placeList){
	var markers = new L.MarkerClusterGroup({animateAddingMarkers: true, maxClusterRadius: 300, spiderfyOnMaxZoon: true, showCoverageOnHover:true, zoomToBoundsOnClick: true});
